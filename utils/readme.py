"""README generation for HuggingFace model cards."""
...
def generate_readme(base_model, lora_name, instance_prompt, sample_prompts, models_config):
    """
    Generate a README.md file for HuggingFace model card.

    Args:
        base_model (str): Base model identifier
        lora_name (str): Name of the LoRA
        instance_prompt (str): Trigger word/phrase for the LoRA
        sample_prompts (list): List of sample prompts used during training
